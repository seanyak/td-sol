...
export default function Hero() {
  return (
    <div className="relative w-screen h-screen overflow-hidden shadow-2xl">
      ...
      {/* Heading */}
        <h1 className="relative z-20 tracking-wide pt-[7rem] md:pt-[9rem] px-4 text-center text-white">
            Power Your Home with Confidence <br />
        </h1>
        <h3 className="italic relative z-20 tracking-wide py-16 md:py-24 px-4 text-center text-white">Solar. Electrical. Backup Power. Done Right.</h3>
